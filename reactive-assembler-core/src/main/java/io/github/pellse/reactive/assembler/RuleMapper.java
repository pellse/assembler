...
public interface RuleMapper<T, TC extends Collection<T>, ID, R, RRC>
    ...
    //    private static <T, ID, R> MergeStrategy<ID, R> updateStrategy() {
...
//    }
//
//    private static <T, ID, R> MergeStrategy<ID, R> removeStrategy() {
...
//
//    private static <T, ID, R> MergeStrategy<ID, R> safeStrategy(MergeStrategy<ID, R> strategy) {
