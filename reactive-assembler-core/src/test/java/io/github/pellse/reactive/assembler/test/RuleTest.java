...
import static io.github.pellse.reactive.assembler.Rule.batchRuleBuilder;
...
public class RuleTest {
    ...
    private final BatchRule<Customer, BillingInfo> billingInfoBatchRule =
            batchRuleBuilder(BillingInfo::customerId, oneToOne(cached(this::getBillingInfo)))
                    .withIdExtractor(Customer::customerId);
    private final BatchRule<Customer, List<OrderItem>> orderItemBatchRule =
            batchRuleBuilder(OrderItem::customerId, oneToMany(OrderItem::id, cached(this::getAllOrders)))
                    .withIdExtractor(Customer::customerId);
