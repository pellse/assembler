...
## Kotlin Support
[![Maven Central](https://img.shields.io/maven-central/v/io.github.pellse/assembler-kotlin-extension.svg?label=assembler-kotlin-extension)](https://central.sonatype.com/artifact/io.github.pellse/assembler-kotlin-extension)
```kotlin
sealed interface MyEvent<T> {
  val item: T
}
