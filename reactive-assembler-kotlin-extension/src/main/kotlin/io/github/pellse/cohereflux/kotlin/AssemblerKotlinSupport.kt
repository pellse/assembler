...
import io.github.pellse.cohereflux.CohereFluxBuilder.WithCorrelationIdResolverBuilder
import io.github.pellse.cohereflux.CohereFluxBuilder.cohereFluxOf
import io.github.pellse.cohereflux.RuleMapper
...
inline fun <reified T> cohereFlux(): WithCorrelationIdResolverBuilder<T> = cohereFluxOf(T::class.java)
